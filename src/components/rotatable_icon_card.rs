        ...
        div {
            ...
            div {
                ...
                div {
                    ...
                    div {
                        class: "absolute inset-0 min-h-full h-fit w-full rounded-xl bg-main/55 [transform:rotateY(180deg)] [backface-visibility:hidden]",
                        div {
                            class: "flex min-h-full flex-col justify-center items-center text-center text-sm lg:text-xl",
                            h1 {
                                class: "font-bold text-slate-50 py-1 lg:py-5",
